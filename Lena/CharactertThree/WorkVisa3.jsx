    ...
    <View style={s.container}>
      <View style={s.box}>
        ...
        <View style={s.row}>
          ...
          <TouchableOpacity onPress={() => nav.navigate("H1B3")}>
          <View style={s.button}>
            <Text style={s.btext}>
          ...
          <TouchableOpacity onPress={() => nav.navigate("H2A3")}>
          <View style={s.button}>
            <Text style={s.btext}>
          ...
          <TouchableOpacity onPress={() => nav.navigate("H2B3")}>
          <View style={s.button}>
            <Text style={s.btext}>
