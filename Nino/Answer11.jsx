...
export function Answer11(){
  ...
  return (
    ...
    <TouchableOpacity onPress={() => nav.navigate("Continue11")}>
    ...
    <View style={s.row}>
        <View style={s.box}>
            <Text style={s.text}>
           You choose to write back that life here isn't all that it seems. You are drained and the people are not treating you right. Your family advises that you should come back home. Will you listen to their advice or stay?
            </Text>
        </View>
